...
API_HASH = environ('API_HASH', 'ff966fef88a9a169153029cfe3d026e3'))
BOT_TOKEN = environ('BOT_TOKEN', '6053122617:AAFp_z8bCpmSIA1sRh6QTDldnyXvhwZ-GPI'))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "MxA_Bots")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", Join @Movies_X_Animes)
...
SHORTNER_SITE = environ.get('SHORTENR_SITE', 'shorturllink.in')
SHORTNER_API = environ.get('SHORTNER_API', '0aad30f601b7b8894b4f62da77fed42878712ddc')
